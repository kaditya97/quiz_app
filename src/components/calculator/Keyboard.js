    ...
    return (
      <div>
        ...
        <div className="keyboard-row">
          ...
          <Key className="orange-button calc-button" Tag="DEL" math="delete" keyClick={keyClick} />
          <Key className="orange-button calc-button" Tag="AC" math="clear" keyClick={keyClick} />
        </div>
        <div className="keyboard-row">
